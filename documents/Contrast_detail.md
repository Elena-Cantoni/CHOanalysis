...
# Contrast_detail
**Contrast_detail.py** is a functions module concerning the selection of data and creation of contrast-detail curve dataset.
...
txt = '.\data\cd_CORO_LAAG_0004.txt'
files, num_alpha, path_s, alpha_s, human_s = Contrast_detail.strings(txt)
m_contrast = genfromtxt('./pkl/m_contrast.csv', delimiter=',')
